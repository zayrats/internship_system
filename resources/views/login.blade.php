        ...
        <div
            ...
            <div class="hidden md:flex items-center justify-center bg-gradient-to-br from-blue-500 to-indigo-600">
                <img src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/authentication/illustration.svg"
                    alt="Login Illustration" class="w-3/4">
            </div>
            ...
            <div class="p-8 sm:p-12">
                ...
                @if (session('error'))
                    <div id="alert-border-error"
                        class="flex items-center p-4 mb-4 text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-red-900 dark:text-red-300 dark:border-red-800"
                        role="alert">
                        ...
                        <button type="button"
                            class="ms-auto -mx-1.5 -my-1.5 bg-red-50 dark:bg-red-900 text-red-500 rounded-lg focus:ring-2 focus:ring-red-400 p-1.5 hover:bg-red-200 dark:hover:bg-red-800 inline-flex items-center justify-center h-8 w-8"
